function createProjectElement(
    ...
    newProjectLi.dataset.projectId = project.id;

    // Add selected class if this project is the selected one
    if (project.id === appState.selectedProjectId) {
        newProjectLi.classList.add("project--selected");
    }
...
export function updateProjectNav(
    projectRepository,
    appState,
    onProjectSelect,
    onProjectDelete
